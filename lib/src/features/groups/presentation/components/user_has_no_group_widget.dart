        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                TextButton(
                    onPressed: () => CreateGroupModal.show(context), child: Text(LocaleKeys.groups_create_button.tr())),
                TextButton(
                    onPressed: () => JoinGroupModal.show(context), child: Text(LocaleKeys.groups_join_button.tr())),
              ],
            )
          ],
        ),
